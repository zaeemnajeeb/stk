...
_dative_reactions = {
    frozenset({1}): _dative_one_one_reaction,
}
...
class DativeReactionFactory(ReactionFactory):
    ...
    def get_reaction(self, construction_state, edge_group):
        ...
        if bond_order == 9:
            return _dative_reactions[_get_reaction_key(
                functional_groups
            )](
                construction_state=construction_state,
                functional_group1=functional_group1,
