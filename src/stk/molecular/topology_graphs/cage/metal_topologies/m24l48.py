...
class M24L48(Cage):
    ...
    _vertex_prototypes = (
        _MetalVertex(0, [_coord1, _coord1, _coord4]),
        _MetalVertex(1, [_coord1, _coord1, _coord5]),
        _MetalVertex(2, [_coord1, _coord4, _coord2]),
        _MetalVertex(3, [_coord1, _coord5, _coord2]),
        _MetalVertex(4, [_coord1, _coord2, _coord4]),
        _MetalVertex(5, [_coord1, _coord2, _coord5]),
        _MetalVertex(6, [_coord1, _coord4, _coord1]),
        _MetalVertex(7, [_coord1, _coord5, _coord1]),
        _MetalVertex(8, [_coord2, _coord1, _coord4]),
        _MetalVertex(9, [_coord2, _coord1, _coord5]),
        _MetalVertex(10, [_coord2, _coord2, _coord4]),
        _MetalVertex(11, [_coord2, _coord2, _coord5]),
        _MetalVertex(12, [_coord2, _coord4, _coord1]),
        _MetalVertex(13, [_coord2, _coord5, _coord1]),
        _MetalVertex(14, [_coord2, _coord4, _coord2]),
        _MetalVertex(15, [_coord2, _coord5, _coord2]),
        _MetalVertex(16, [_coord4, _coord1, _coord1]),
        _MetalVertex(17, [_coord4, _coord2, _coord1]),
        _MetalVertex(18, [_coord4, _coord2, _coord2]),
        _MetalVertex(19, [_coord4, _coord1, _coord2]),
        _MetalVertex(20, [_coord5, _coord1, _coord1]),
        _MetalVertex(21, [_coord5, _coord2, _coord1]),
        _MetalVertex(22, [_coord5, _coord2, _coord2]),
        _MetalVertex(23, [_coord5, _coord1, _coord2]),
